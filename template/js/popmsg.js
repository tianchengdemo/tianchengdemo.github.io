...
{
    var defaults = { // 默认值。 
        title:'信息提示',   // 标题文本，若不想显示title请通过CSS设置其display为none 
        ...
        center:true,        // 是否居中。 
        fixed:true,         // 是否跟随页面滚动。
        time:20000,         // 自动关闭时间，为0表示不会自动关闭。 单位为毫秒，30000表示30秒
...
function showDialog(tit,url) {
	return new Dialog('<iframe scrolling="no" width="100%"  frameborder="0" name="bb" src="'+url+'"></iframe>',{fixed:false,title:tit}).show();
}